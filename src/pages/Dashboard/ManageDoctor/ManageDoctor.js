...
const ManageDoctor = () => {
    ...
    const { data: doctors, isLoading, refetch } = useQuery({
        ...
        queryFn: async () => {
            try {
                const res = await fetch('https://doctors-portal-server-ruby-beta.vercel.app/doctors', {
                    headers: {
    ...
    const handleDeleteDoctor = doctor => {
        fetch(`https://doctors-portal-server-ruby-beta.vercel.app/doctors/${doctor._id}`, {
            method: 'DELETE', 
            headers: {
                authorization: `bearer ${localStorage.getItem('accessToken')}`
            }
